...
public class ComputerDetailsDataService {
	public static Computer recupDataDetailsOrdi() throws Exception {
		try (Connection con = AccessDatabase.getInstance();) {
			return ComputerInfos.computerDetailsMapper(ComputersInfosDao.computerInformationsDetails(con));
